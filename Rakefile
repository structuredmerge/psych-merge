...
# kettle-jem:freeze
# To retain chunks of comments & code during psych-merge templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# psych-merge will then preserve content between those markers across template runs.
# kettle-jem:unfreeze

# psych-merge Rakefile v1.0.0 - 2026-04-03
...
# rake install                                # Build and install psych-merge-1.0.0.gem in...
# rake install:local                          # Build and install psych-merge-1.0.0.gem in...
# rake kettle:jem:install                     # Install psych-merge GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template psych-merge against itse...
# rake kettle:jem:template                    # Template psych-merge files into the curren...
