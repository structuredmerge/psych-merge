...
**Note**: Always make commands self-contained. Use `mise exec -C /home/pboling/src/kettle-rb/psych-merge -- ...` so the command gets the project environment in the same invocation.
